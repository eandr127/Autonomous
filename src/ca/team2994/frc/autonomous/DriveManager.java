...
public interface DriveManager {
	 ...
	 * 
	 * @param units
	 *            Number of units to drive forward. Determined by calibration.
	 * 
	 * @param usePID
	...
	/**
	 * Turns degrees degrees to the left when degrees is negative and to the
	 * right when degrees is positive. TODO: Check if left and right turns are
	 * actually always negative and positive respectively.
	 * 
	 * @param degrees
	...
	/**
	 * Drive using arcade drive. This means that the joystick will be used so
	 * that the y axis (up and down on the joystick) will move the robot forward
	 * and backwards and the x axis (left and right on the joystick) will spin
	...
	/**
	 * Loop for recording waypoints to be run in autonomous
	 * 
	 * @return Whether to log waypoints or to drive normally in autonomous
	 */
	public boolean doRobotLogging();

	/**
	 * Get whether to use PID or to dead reckon
	 * 
	 * @return Whether to use PID or to use dead reckoning
	 */
