...
public class Robot extends SampleRobot {
	...
	/**
	 * The manager of the robot driving
	 */
	public static DriveManager driveManager;

	/**
	 * The autonomous mode that will be run
	 */
	...
	/**
	 * Initialize PID values for the gyro, then call
	 * {@link DriveManager#runAutonomous() runAutonomous()}
	 */
	...
	/**
	 * Calibration for encoders TODO: Tell user to drive 5 feet
	 */
	public void test() {
